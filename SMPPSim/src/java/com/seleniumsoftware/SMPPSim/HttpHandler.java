 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/HttpHandler.java,v 1.15 2010/10/10 07:03:35 martin Exp $
 ****************************************************************************
 */
...
//			logger.info(token);
		...
		if (args.containsKey("tlv5_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv5_val"));
		...
		if (args.containsKey("tlv6_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv6_val"));
		...
		if (args.containsKey("tlv7_tag")) {
			...
			byte[] val = makeBinaryMessage(args.get("tlv7_val"));
